        ...
        <Container>
          <div className='flex flex-wrap gap-4 items-center mx-auto max-w-[1200px] mb-8'>
            ...
            <div className='flex-1 content-end min-w-[500px]'>
              ...
              <p className='text-sm leading-7 text-brand-dark opacity-70 lg:text-15px lg:leading-loose'>
                ...
                merchants for customers. It’s a unique online discount
                aggregator brand in Bangladesh where customers and merchants
                connect with each other. Offer Zone offers customers to discover
                the best available offers or discounts in the market through its
                partners or merchants, resulting into lots of saving, better
                living to customers and enhance merchant business.
              </p>
            </div>
          </div>
          ...
          <div className='flex flex-col w-full mx-auto max-w-[1200px] mt-4'>
            <div>
              ...
              <p className='text-sm leading-7 text-brand-dark opacity-70 lg:text-15px lg:leading-loose'>
                Encourage people to save more and live better with the best available discounts or offers from Offer Zone platform.
              </p>
            </div>
          </div>
          ...
          <div className='flex flex-col w-full mx-auto max-w-[1200px] mt-4'>
            <div>
              ...
              <p className='text-sm leading-7 text-brand-dark opacity-70 lg:text-15px lg:leading-loose'>
                Our vision is to replace multiple membership card of different merchant by Offer Zone privilege card. This will be a common privilege card for all customer.              </p>
            </div>
          </div>
          <img src='/assets/images/about-us/agent_registration.png' className='mt-10' />
          <img src='/assets/images/about-us/member_registration.png' className='mt-10' />
          <img src='/assets/images/about-us/merchant_registration.png' className='mt-10' />
          <img src='/assets/images/about-us/offer_avail.png' className='mt-10' />
          <img src='/assets/images/about-us/offer_purchase.png' className='mt-10' />
        </Container>
      </div>
