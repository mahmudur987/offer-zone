      ...
      <div className='grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 pb-[50px]'>
        ...
        {widgets?.map((widget) => (
          <WidgetLink
            ...
            data={widget}
            className='pt-3 pb-3.5 sm:pb-0 col-span-1 md:col-span-2'
          />
        ))}
        <WidgetSubscription
          className={cn(
            'pt-8 border-t col-span-full sm:col-span-1 xl:col-start-auto md:col-span-4 xl:col-span-4 xl:ltr:pl-6 xl:rtl:pr-6 sm:pt-0 sm:border-t-0 border-border-three',
            {
